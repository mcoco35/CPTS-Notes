...
- [3rd Party Applications](#id-3rd-party-applications)
- [Information Gathering](#information-gathering)
- [Enumeration Modules](#enumeration-modules)
- [Privilege Escalation](#privilege-escalation-1)
- [Spy modules](#spy-modules)
- [Forensic Modules](#forensic-modules)
- [Generic](#generic)
- [Browser Modules](#browser-modules)
- [Browser modules (Firefox)](#browser-modules-firefox)
- [Browser modules (Chrome)](#browser-modules-chrome)
- [Browser modules (Internet Explorer)](#browser-modules-internet-explorer)
- [Browser modules (Multiple)](#browser-modules-multiple)
