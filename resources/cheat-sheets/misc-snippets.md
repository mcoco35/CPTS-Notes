...
##Spoof Checking
SmartFense: [https://www.smartfense.com/en-us/tools/spoofcheck/](https://www.smartfense.com/en-us/tools/spoofcheck/)Spoofcheck: [https://github.com/BishopFox/spoofcheck](https://github.com/BishopFox/spoofcheck)
...
##Wpscan
All plugins detectionbLast updated 10 months ago- [Linux](#linux)
- [Generate Relay list](#generate-relay-list)
- [Spoof Checking](#spoof-checking)
- [PowerShell Encoded String](#powershell-encoded-string)
- [Wpscan](#wpscan)

```
wpscan --url http:// -t 40 --detection-mode mixed --enumerate ap --plugins-detection aggressive
```
